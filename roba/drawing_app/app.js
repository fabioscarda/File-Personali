...
function pen() {
    colorButton();
    draw_width = "5";
    document.getElementById("pen").style.border = "2px solid "+ draw_color;
}

function highlighter() {
    colorButton();
    draw_width = "20";
    document.getElementById("highlighter").style.border = "2px solid "+ draw_color;
}
...
function bucket() {
    ...
    ctx.fillRect(0, 0, canvas.width, canvas.height);
    document.getElementById("bucket").style.border = "2px solid "+ draw_color;
}

function eraser(){
    colorButton();
    draw_color = "white";
    document.getElementById("eraser").style.border = "2px solid "+ draw_color;
}
...
function colorButton(){
    ...
    pen.style.border = "2px solid white";
    highlighter.style.border = "2px solid white";
    bucket.style.border = "2px solid white";
